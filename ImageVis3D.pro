...
UI_DIR            = UI/AutoGen
MOC_DIR           = UI/AutoGen
unix:LIBS        += -L/3rdParty/GLEW/lib/Linux -llibGLEW.so.1.5.0
win32:LIBS       += -L/3rdParty/GLEW/lib/Windows -lglew32.lib
mac:LIBS         += -L/3rdParty/GLEW/lib/Mac -llibGLEW.1.5.0.dylib
DEPENDPATH       += .
INCLUDEPATH      += .
QT               += opengl
