...
- An unsigned, 64-bit integer offset to the next block.  This is
  relative to the _beginning_ of the current block.
...
- `n_elements` 64-bit unsigned integers giving the element size (number
of bytes element) per dimension.
...
